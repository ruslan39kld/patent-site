                          ...
                          <div className="pt-4">
                             ...
                             <div className="flex items-start mt-4">
                               ...
                               <label htmlFor="privacy2" className="ml-2 block text-xs text-gray/80 leading-relaxed cursor-pointer">
                                 Нажимая кнопку, вы даете согласие на обработку персональных данных в соответствии с <Link to="/privacy" className="underline hover:text-primary">Политикой конфиденциальности</Link>.
                               </label>
                             </div>
                          </div>
                       </form>
