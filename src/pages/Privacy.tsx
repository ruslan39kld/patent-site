...
export default function Privacy() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] relative overflow-hidden pb-24">
      ...
      <div className="absolute bottom-1/2 left-0 w-[600px] h-[600px] bg-[#3B82F6]/10 rounded-full blur-[150px] pointer-events-none transform -translate-x-1/3"></div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 relative z-10">
        ...
        <div className="mb-8 relative">
           <div className="absolute top-1/2 left-0 -translate-y-1/2 w-32 h-32 bg-[#3B82F6]/20 blur-[50px] rounded-full pointer-events-none"></div>
