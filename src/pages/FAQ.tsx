      ...
      <div className="max-w-[1400px] mx-auto px-4 lg:px-8 py-8 h-[calc(100vh-80px)] lg:h-[calc(100vh-100px)] flex flex-col lg:flex-row gap-8 overflow-hidden">
        ...
        <div className={cn(
          ...
          <div className="mb-6 shrink-0 relative">
            <div className="absolute top-0 left-0 w-32 h-32 bg-[#3B82F6]/10 blur-[50px] rounded-full pointer-events-none"></div>
        ...
        <div className={cn(
          ...
          {!selectedQuestion && messages.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-[#F8FAFC] relative overflow-hidden">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[500px] h-[300px] bg-[#3B82F6]/10 blur-[100px] rounded-full pointer-events-none"></div>
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto px-6 py-6 bg-[#F8FAFC] flex flex-col gap-6 relative">
                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[400px] h-[400px] bg-[#3B82F6]/5 blur-[80px] rounded-full pointer-events-none"></div>
