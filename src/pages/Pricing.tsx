...
const faqs = [
  ...
  {
    q: 'Что входит в стоимость услуг, а что нет?',
    a: 'Стоимость включает все работы специалиста: поиск, подготовку документов, подачу, переписку с Роспатентом. Госпошлины — отдельная статья расходов.'
  },
  {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#3B82F6]/5 rounded-full blur-[120px]"></div>
                        ...
                        <table className="w-full text-left min-w-[700px]">
                          <thead>
                            <tr className="bg-[#EEF3FB]/50 border-b border-[#E5E7EB]">
                              ...
                              <th className="py-6 px-8 font-bold text-[#1B3F7A] text-[15px] uppercase tracking-wider w-1/5">Стоимость</th>
