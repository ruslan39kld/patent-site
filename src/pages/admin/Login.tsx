  ...
  return (
    <div className="min-h-screen bg-[#FFF8E8] flex flex-col justify-center items-center px-4 relative selection:bg-[#1B3F7A] selection:text-white font-sans text-[#1E293B]">
      ...
      <div className="w-full max-w-md relative z-10">
        <Link
          to="/"
          className="inline-flex items-center text-[#1B3F7A] font-bold hover:text-[#3B82F6] transition-colors mb-4"
        >
          <ArrowLeft className="w-4 h-4 mr-2" /> Вернуться на сайт
        </Link>

        <div className="bg-white/80 backdrop-blur-xl border border-[#E2E8F0] p-8 rounded-2xl shadow-xl w-full">
