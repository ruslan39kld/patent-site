        ...
        <div className="bg-white border border-[#E2E8F0] rounded-b-xl rounded-tr-xl shadow-sm p-6">
          ...
          <div className="max-w-md space-y-4">
             <div>
                ...
                <input 
                  type="text" 
                  value={state.content.adminLogin || ''}
                  onChange={(e) => updateState({ content: { ...state.content, adminLogin: e.target.value } })}
                  className="w-full px-4 py-2 border border-[#E2E8F0] rounded-lg focus:ring-2 focus:ring-[#1B3F7A]/20 focus:border-[#1B3F7A] outline-none"
                  placeholder="admin"
                />
             </div>
             <div>
                ...
                <input 
                  type="text" 
                  value={state.content.adminPassword || ''}
                  onChange={(e) => updateState({ content: { ...state.content, adminPassword: e.target.value } })}
                  className="w-full px-4 py-2 border border-[#E2E8F0] rounded-lg focus:ring-2 focus:ring-[#1B3F7A]/20 focus:border-[#1B3F7A] outline-none"
                  placeholder="admin"
                />
             </div>
             <div className="pt-2">
                <button 
                  onClick={() => alert('Настройки безопасности сохранены')}
                  className="bg-[#1B3F7A] text-white hover:bg-[#1B3F7A]/90 px-6 py-2 rounded-lg font-medium transition-colors"
                >
                  Применить изменения
                </button>
             </div>
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-b-xl rounded-tr-xl shadow-sm p-6 space-y-4">
           ...
           <div className="flex justify-end">
              <button 
                 ...
                 className="bg-gray-900 hover:bg-black text-[#0F172A] px-6 py-2 rounded-lg font-medium transition-colors flex items-center"
              >
