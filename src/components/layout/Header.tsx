...
export default function Header() {
  ...
  useEffect(() => {
    ...
    const sections = ['hero', 'services', 'tasks', 'cases', 'about', 'pricing', 'contact'];
  ...
  return (
    <header className={cn(
      "fixed w-full top-0 z-50 transition-all duration-300 ease-in-out bg-white border-b-2 border-[#C8A028]",
      isScrolled 
