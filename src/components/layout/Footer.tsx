...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#1B3F7A] text-white relative overflow-hidden w-full">
      {/* Neon Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#3B82F6]/20 rounded-full blur-[150px] pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="font-bold text-xl uppercase tracking-wider text-white">Виктория Тарасова</span>
            </div>
