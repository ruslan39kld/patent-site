...
export default function PricingHomeBlock() {
  ...
  const pricingBlock = content?.pricingBlock || {
    ...
    text: "Мои гонорары фиксируются прозрачно до начала работ. Итоговая сумма зависит от:",
    badges: [
      "Сложности объекта",
      "Количества классов",
      "Региона регистрации",
          ...
          <div className="w-full lg:w-[45%] flex flex-col flex-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
               {pricingBlock.badges.map((badge, idx) => (
                 <div key={idx} className="flex items-center font-bold text-[#1F2937] bg-white px-5 py-4 rounded-xl border border-[#3B82F6]/60 shadow-[0_0_20px_rgba(59,130,246,0.25)] hover:shadow-[0_0_35px_rgba(59,130,246,0.6)] hover:border-[#3B82F6] transition-all duration-300 hover:-translate-y-1 relative overflow-hidden group/card">
