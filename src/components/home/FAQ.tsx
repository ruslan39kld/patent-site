...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-24 bg-white border-t border-[#F3F4F6] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center">
          <Link 
            ...
            className="inline-flex items-center justify-center bg-white border border-[#3B82F6]/30 text-[#1B3F7A] px-8 py-3 rounded-lg font-bold transition-all shadow-[0_0_15px_rgba(59,130,246,0.1)] hover:shadow-[0_0_25px_rgba(59,130,246,0.3)] hover:bg-[#3B82F6] hover:text-white hover:border-[#3B82F6]"
          >
