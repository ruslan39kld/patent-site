...
export default function IPAssetBlock() {
  ...
  return (
    <section  className="animate-on-scroll py-24 bg-transparent relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="w-full lg:w-1/2">
            <div 
              className="photo-placeholder w-full max-w-[500px] mx-auto h-[350px] md:h-[450px] border border-[#E5E7EB] rounded-[24px] flex items-center justify-center"
              style={{
          ...
          <div className="w-full lg:w-1/2">
             <div className="flex flex-col gap-6">
                {assets.map((item, i) => (
                  <div key={i} className="flex gap-4 p-4 rounded-xl hover:transition-colors border border-transparent hover:border-[#E5E7EB]">
