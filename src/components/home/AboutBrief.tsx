...
export default function AboutBrief() {
  ...
  return (
    <section  id="about" className="animate-on-scroll py-24 bg-[#EEF3FB] relative overflow-hidden rounded-[40px] mx-4 my-12 shadow-sm">
      ...
      <Modal isOpen={!!selectedCert} onClose={() => { setSelectedCert(null); setIsZoomed(false); }} className="p-0 bg-[#F8F9FA] border-none shadow-none md:shadow-none w-full max-w-5xl max-h-[900px] overflow-hidden" hideCloseButton>
        {selectedCert && (
          <div className="flex flex-col items-center justify-center w-full h-full">
            <div 
              className="w-full h-full max-w-5xl rounded-2xl md:rounded-3xl shadow-2xl flex flex-col overflow-hidden border border-[#3B82F6]/20 relative mx-auto"
            ...
            >
              ...
              <div className="w-full h-[80px] bg-[#1B3F7A] flex items-center px-4 md:px-8 shrink-0 relative overflow-hidden text-left shadow-md z-10">
                 ...
                 <div className="w-10 h-10 md:w-12 md:h-12 bg-[#F8F9FA]/10 border border-white/20 rounded-2xl flex items-center justify-center text-white shadow-[0_0_15px_rgba(255,255,255,0.1)] relative z-10 shrink-0">
                 ...
                 <div className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 flex items-center gap-2 z-20">
                   <button 
                    ...
                    className="w-8 h-8 md:w-10 md:h-10 rounded-full border border-white/10 bg-[#F8F9FA]/5 flex items-center justify-center text-white/70 hover:text-white hover:bg-[#F8F9FA]/20 hover:border-white/30 transition-all font-medium"
                   ...
                   <button 
                    ...
                    className="w-8 h-8 md:w-10 md:h-10 rounded-full text-[#1B3F7A] hover:bg-gray-100 flex items-center justify-center transition-all"
                    title="Закрыть"
              ...
              <div className="w-full p-4 md:p-8 bg-[#E2E8F0] flex-1 overflow-auto min-h-0 relative">
                 <div className={`shadow-2xl overflow-hidden flex flex-col mx-auto relative border border-[#CBD5E1] transition-all duration-300 ${isZoomed ? 'w-[200%] md:w-[150%] xl:w-[200%] max-w-none origin-top-left' : 'w-full max-w-xl md:max-w-3xl origin-top'}`}>
