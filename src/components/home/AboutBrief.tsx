...
import { Award, Briefcase, FileSignature, Shield, Lock, ExternalLink, ZoomIn, ZoomOut, X, ArrowRight, FileText } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row-reverse gap-16 items-stretch">
          ...
          <div className="lg:w-7/12 animate-on-scroll stagger-2 flex flex-col justify-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
               {aboutCards.map((card: any, i: number) => (
                 <div key={i} className="relative group p-8 rounded-[24px] bg-white border border-[#E5E7EB] shadow-[0_0_20px_rgba(59,130,246,0.08)] hover:border-[#3B82F6]/40 transition-all duration-300 hover:shadow-[0_0_40px_rgba(59,130,246,0.25)] hover:-translate-y-1">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center w-full gap-6 mt-auto pb-4">
               <button 
                 ...
                 className="w-full sm:w-auto bg-gradient-to-r from-[#1B3F7A] to-[#3B82F6] hover:from-[#1e40af] hover:to-[#2563EB] text-white text-center px-10 py-5 rounded-xl font-bold transition-all shadow-[0_4px_20px_rgba(59,130,246,0.3)] hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(59,130,246,0.4)] text-lg relative overflow-hidden group outline-none"
               >
          ...
          <div className="lg:w-5/12 w-full animate-on-scroll shrink-0 relative mt-8 lg:mt-0 lg:pt-16 lg:pb-[104px]">
            ...
            <div className="relative w-full aspect-[4/5] sm:aspect-[3/4] lg:aspect-auto lg:h-full rounded-2xl border bg-white border-[#E5E7EB] shadow-[0_20px_50px_rgba(27,63,122,0.08)] group overflow-visible">
               ...
               <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-30 transition-transform duration-300 group-hover:-translate-y-1">
                  <div className="bg-white/95 backdrop-blur-md px-8 py-3 rounded-xl border border-white shadow-[0_10px_30px_rgba(0,0,0,0.15)] flex flex-col items-center">
               ...
               <div className="absolute top-12 -left-6 sm:-left-10 bg-white/95 backdrop-blur-xl px-5 py-4 rounded-xl border border-[#E5E7EB] shadow-[0_15px_35px_rgba(27,63,122,0.15)] z-30 flex flex-col items-center gap-2 hover:-translate-y-1 transition-transform duration-300 pointer-events-auto group-hover:scale-105 group-hover:border-[#3B82F6]/30">
        ...
        <div id="certificates-section" className="mt-12 animate-on-scroll stagger-3 scroll-mt-32">
                 ...
                 <div className="w-full aspect-[1/1.4] bg-[#F8FAFC] border border-[#E5E7EB] rounded-lg mb-4 md:mb-5 relative overflow-hidden shadow-sm flex flex-col items-center justify-center p-2 group-hover:border-[#3B82F6]/30 transition-colors z-10 mxauto max-w-[140px]">
                   {(cert as any).image ? (
                     (cert as any).image.startsWith('data:application/pdf') ? (
                       <div className="absolute inset-0 overflow-hidden bg-white pointer-events-none p-1">
                          <PdfViewer 
            ...
            >
              ...
              <div className="w-full p-4 md:p-8 bg-[#E2E8F0] flex-1 overflow-auto min-h-0 relative">
                 <div className={`bg-white shadow-2xl overflow-hidden flex flex-col mx-auto relative border border-[#CBD5E1] transition-all duration-300 ${isZoomed ? 'w-[200%] md:w-[150%] xl:w-[200%] max-w-none origin-top-left' : 'w-full max-w-xl md:max-w-3xl origin-top'}`}>
                    {(selectedCert as any).image?.startsWith('data:application/pdf') ? (
                       <PdfViewer 
                         base64={(selectedCert as any).image} 
                         className={`w-full h-[60vh] md:h-[80vh] border-0 transition-all duration-500`}
                       />
                    ) : (
                      <img 
