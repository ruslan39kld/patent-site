    ...
    <section id="process" className="py-24 bg-white overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              return (
                <div key={i} className={cn("relative flex flex-col md:flex-row items-center w-full animate-on-scroll group", `stagger-${Math.min(i + 1, 6)}`, isEven ? "md:flex-row" : "md:flex-row-reverse")}>
                  ...
                  <div className="w-full md:w-2/12 flex justify-center py-6 md:py-0 relative z-10 hidden md:flex">
                    <div className="w-14 h-14 rounded-full bg-white shadow-[0_0_0_8px_#ffffff] border-4 border-[#1B3F7A]/30 group-hover:border-[#1B3F7A] flex items-center justify-center text-[#1B3F7A] font-bold text-xl transition-colors duration-300">
                  ...
                  <div className={cn("w-full md:w-5/12 mt-6 md:mt-0 relative z-10", isEven ? "md:pl-12" : "md:pr-12")}>
                     {step.image ? (
                        <div className="w-full h-[200px] border border-[#1B3F7A]/20 rounded-2xl flex flex-col items-center justify-center transition-all duration-300 shadow-[0_0_15px_rgba(27,63,122,0.1)] group-hover:shadow-[0_0_30px_rgba(27,63,122,0.3)] group-hover:border-[#1B3F7A]/40 group-hover:-translate-y-1 relative overflow-hidden">
                       ...
                       <div className="w-full h-[200px] bg-gradient-to-br from-[#EEF3FB] to-[#E2EAF8] border border-[#1B3F7A]/20 rounded-2xl flex flex-col items-center justify-center text-[#6B7280] transition-all duration-300 shadow-[0_0_15px_rgba(27,63,122,0.1)] group-hover:shadow-[0_0_30px_rgba(27,63,122,0.3)] group-hover:border-[#1B3F7A]/40 group-hover:-translate-y-1 relative overflow-hidden">
                          ...
                          <div className="relative z-10 flex flex-col items-center">
                            <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mb-3 shadow-[0_4px_10px_rgba(27,63,122,0.1)] transition-transform group-hover:scale-110 duration-500">
                              <span className="text-2xl">⚡</span>
                            </div>
                            <div className="text-sm font-bold uppercase tracking-widest text-[#1B3F7A]">Иллюстрация</div>
                            <div className="text-xs mt-1 text-[#2960B0] font-medium bg-white/50 px-2 py-1 rounded">300 × 200 px</div>
                          </div>
                       </div>
                     )}
                  </div>
        ...
        <div className="mt-24 flex justify-center animate-on-scroll stagger-3">
            <div className="inline-flex items-center space-x-3 bg-white border border-[#1B3F7A]/20 px-8 py-5 rounded-xl text-[#1F2937] font-bold shadow-[0_0_20px_rgba(27,63,122,0.1)] hover:shadow-[0_0_30px_rgba(27,63,122,0.2)] hover:border-[#1B3F7A]/40 transition-all duration-300 cursor-default hover:-translate-y-1">
