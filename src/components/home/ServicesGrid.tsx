...
export default function ServicesGrid() {
  ...
  return (
    <section  id="services" className="animate-on-scroll py-24 bg-white relative rounded-[40px] mx-4 my-12 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {state.services.slice(0, 6).map((svc, i) => (
            <div key={svc.id} className={cn(
              "bg-white flex flex-col overflow-hidden relative transition-all duration-500 group rounded-2xl border border-[#C5D5EE] shadow-[0_0_15px_rgba(27,63,122,0.15)] hover:shadow-[0_0_30px_rgba(27,63,122,0.4)] hover:border-[#1B3F7A]/60 hover:-translate-y-1",
              ...
              <button 
                ...
                className="w-full relative overflow-hidden group/btn bg-[#C8A028] hover:bg-[#E8C050] text-white transition-all shadow-[0_4px_15px_rgba(200,160,40,0.3)] hover:shadow-[0_4px_25px_rgba(200,160,40,0.5)] duration-300 py-4 flex items-center justify-center text-[14px] font-bold focus:outline-none"
              >
