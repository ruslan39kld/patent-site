...
export default function Risks() {
  ...
  return (
    <section id="risks" className="py-24 bg-white relative overflow-hidden animate-on-scroll">
      ...
      <div className="absolute top-0 right-0 -mt-32 -mr-32 w-[600px] h-[600px] rounded-full bg-[#F0F4FF] opacity-50 blur-3xl pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col space-y-8 lg:pr-8">
            ...
            <div className="relative rounded-[20px] overflow-hidden bg-gradient-to-br from-[#EEF3FB] to-[#E2EAF8] aspect-[4/3] flex items-center justify-center shadow-inner border border-gray-100 group animate-on-scroll stagger-2">
