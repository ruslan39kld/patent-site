...
export default function Risks() {
  ...
  return (
    <section  id="risks" className="animate-on-scroll py-24 bg-white relative overflow-hidden rounded-[40px] mx-4 my-12 shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col space-y-8 lg:pr-8 animate-on-scroll stagger-1">
            <div>
            ...
            <div className="relative rounded-[20px] overflow-hidden bg-gradient-to-br from-[#EEF3FB] to-[#E2EAF8] aspect-[4/3] flex items-center justify-center shadow-inner border border-gray-100 group  stagger-2 group/img">
              ...
              {!state.content?.risksImage && (
                <div className="text-center relative z-10 p-6">
                  <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 shadow-[0_8px_30px_rgba(27,63,122,0.08)] border border-gray-50 transition-transform group-hover:scale-110 duration-500">
                  ...
                  <div className="inline-block mt-4 bg-[#FBF3DC]/60 px-3 py-1.5 rounded-md text-[#1B3F7A]/80 text-[11px] font-bold border border-white">
                    Размер: 800 × 600 px
                  </div>
                </div>
              )}
          ...
          <div className="flex flex-col space-y-4 relative animate-on-scroll stagger-2">
              ...
              >
                <div className="shrink-0 mr-5 mt-0.5 relative bg-white ">
                  <div className="w-10 h-10 rounded-full bg-[#FFF0F0] flex items-center justify-center group-hover:bg-[#FF4444] transition-colors duration-300">
                    <span className="w-2 h-2 rounded-full bg-[#FF4444] group-hover:transition-colors duration-300"></span>
                  </div>
