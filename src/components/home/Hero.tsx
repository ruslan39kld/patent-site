        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start mb-24">
          ...
          <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 relative z-10 animate-on-scroll stagger-3 w-full lg:w-auto">
              <button 
                ...
                className="btn-pulse inline-flex items-center justify-center w-full sm:w-auto bg-[#1B3F7A] hover:bg-[#2960B0] text-white px-8 py-4 rounded-lg font-bold text-lg transition-all shadow-lg hover:-translate-y-1 group border-none outline-none"
              >
                Обсудить задачу
          ...
          <div className="lg:col-span-5 relative flex flex-col animate-on-scroll stagger-2 order-first lg:order-none mb-12 lg:mb-0">
            <div className="w-full relative rounded-2xl max-w-[340px] md:max-w-[440px] lg:max-w-[440px] mx-auto lg:ml-auto lg:mr-0 h-[450px] md:h-[600px] flex items-center justify-center transition-transform duration-500 hover:-translate-y-2 group shadow-[0_0_60px_rgba(59,130,246,0.25)] hover:shadow-[0_0_80px_rgba(59,130,246,0.4)]">
              <div className="absolute -inset-0 bg-gradient-to-br from-[#3B82F6]/50 via-[#2563EB]/40 to-[#1B3F7A]/50 rounded-2xl blur-[20px] group-hover:blur-[30px] transition-all duration-500"></div>
              <div className="relative w-full h-full rounded-2xl overflow-hidden bg-white z-10 border border-[#3B82F6]/30">
                <img 
                   src={state.content?.heroImage || "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=800&auto=format&fit=crop"} 
                   alt="Виктория Тарасова" 
                   className="w-full h-full object-cover object-top rounded-2xl"
                />
              </div>
              <div className="absolute -top-10 -right-10 w-[160px] h-[160px] rounded-full bg-[#C8A028]/15 z-0 mix-blend-multiply blur-sm"></div>
