  ...
  return (
    <>
      {activeBlocks.map((block: CustomBlock, index: number) => {
        ...
        return (
          <section  key={block.id} className="animate-on-scroll py-16 relative overflow-hidden group bg-transparent">
            <div className={cn("max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", animClass)}>
              ...
              {block.type === 'image' && block.image ? (
                <div className={cn(
                  ...
                  <div className="flex-1 space-y-6">
                    ...
                    {block.buttonText && block.buttonLink && (
                       <a href={block.buttonLink} className="inline-flex items-center bg-[#C8A028] text-white font-bold py-4 px-8 rounded-xl hover:bg-[#E8C050] transition-colors shadow-[0_4px_15px_rgba(200,160,40,0.3)] hover:-translate-y-1 hover:shadow-[0_4px_25px_rgba(200,160,40,0.5)]">
                          {block.buttonText}
                ...
                <div className="bg-gradient-to-br from-[#1B3F7A] to-[#3B82F6] text-white rounded-3xl p-10 md:p-16 text-center shadow-2xl relative overflow-hidden max-w-5xl mx-auto">
                   <div className="absolute top-0 right-0 -mr-20 -mt-20 w-80 h-80 opacity-10 rounded-full blur-[120px] pointer-events-none"></div>
                   ...
                   <div className="relative z-10 max-w-3xl mx-auto space-y-8">
                      ...
                      {block.buttonText && block.buttonLink && (
                         <a href={block.buttonLink} className="inline-flex items-center text-[#1B3F7A] font-bold py-4 px-10 rounded-xl hover:bg-gray-50 transition-transform shadow-lg hover:-translate-y-1 text-lg">
                            {block.buttonText}
                         </a>
                      )}
                   </div>
