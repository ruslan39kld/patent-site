              ...
              {block.type === 'image' && block.image ? (
                <div className={cn(
                  ...
                  <div className="flex-1 w-full max-w-lg">
                    <img src={block.image} alt={block.title} className="w-full h-auto rounded-2xl shadow-xl object-cover" />
                  </div>
                </div>
              ) : block.type === 'text' ? (
                ...
                <div className="bg-gradient-to-br from-[#1B3F7A] to-[#3B82F6] text-white rounded-3xl p-10 md:p-16 text-center shadow-2xl relative overflow-hidden max-w-5xl mx-auto">
                   <div className="absolute top-0 right-0 -mr-20 -mt-20 w-80 h-80 bg-white opacity-10 rounded-full blur-3xl pointer-events-none"></div>
                   <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 bg-[#C8A028] opacity-10 rounded-full blur-3xl pointer-events-none"></div>
