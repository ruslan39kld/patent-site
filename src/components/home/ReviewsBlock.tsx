      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          {reviews.map((review, i) => (
            <div key={i} className="bg-white flex-none w-[350px] md:w-[400px] p-8 rounded-[24px] shadow-[0_10px_30px_rgba(27,63,122,0.06)] border border-[#E5E7EB] hover:border-[#3B82F6]/50 hover:shadow-[0_0_30px_rgba(59,130,246,0.15)] flex flex-col snap-start h-auto min-h-[420px] transition-all duration-500 group relative">
      ...
      {selectedMedia && (
        <div className="fixed inset-0 z-[100] p-4 sm:p-6 overflow-y-auto">
          ...
          <div className="min-h-full flex items-center justify-center">
            <div className="relative w-full max-w-5xl rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.15)] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-300 border border-[#E5E7EB] mx-auto">
            {/* Tech Header */}
            <div className="flex items-center justify-between p-5 border-b border-[#E5E7EB] bg-gradient-to-r from-[#F8FAFC] to-white relative overflow-hidden">
               ...
               <button 
                 onClick={() => setSelectedMedia(null)}
                 className="p-2 border border-[#E5E7EB] text-[#6B7280] rounded-xl hover:bg-red-50 hover:text-red-500 hover:border-red-200 transition-all relative z-10 group shadow-sm"
               >
            ...
            {/* Media Content */}
            <div className="p-6 overflow-y-auto flex-grow flex items-center justify-center min-h-[50vh] relative">
