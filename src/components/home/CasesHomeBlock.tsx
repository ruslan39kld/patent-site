...
export default function CasesHomeBlock() {
  ...
  return (
    <section id="cases" className="py-24 bg-[#F8F9FA] overflow-hidden relative border-t border-[#E5E7EB]">
      {/* Decorative background circle */}
      <div className="absolute top-0 left-0 -mt-32 -ml-32 w-[600px] h-[600px] rounded-full bg-[#1B3F7A]/5 blur-[100px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-16 text-center animate-on-scroll stagger-4">
           <Link to="/cases" className="inline-flex items-center justify-center bg-white border border-[#1B3F7A]/20 hover:border-[#1B3F7A] text-[#1B3F7A] font-bold px-8 py-4 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 group hover:-translate-y-1">
             Смотреть все кейсы
