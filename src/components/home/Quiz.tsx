...
export default function Quiz() {
  ...
  return (
    <section  id="quiz" className="animate-on-scroll py-24 bg-white relative overflow-hidden rounded-[40px] mx-4 my-12 shadow-sm">
      {/* Decorative Blur Background Elements */}
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[#3B82F6]/10 rounded-full blur-[120px] pointer-events-none transform translate-x-1/3 -translate-y-1/3"></div>
          ...
          {step <= 2 ? (
                    ...
                    <button
                      ...
                      className={`flex text-left items-center p-6 rounded-2xl transition-all duration-300 group relative overflow-hidden outline-none ${
                        isSelected 
                          ...
                          : 'border-2 border-[#E5E7EB] hover:border-[#3B82F6]/50 hover:shadow-[0_10px_30px_rgba(59,130,246,0.1)] hover:-translate-y-1'
                      }`}
                    >
                      {isSelected && (
            ...
            <div className="text-center py-12 animate-in fade-in zoom-in duration-500 relative z-10 w-full flex flex-col items-center">
              ...
              <h4 className="text-3xl md:text-4xl font-black text-[#1B3F7A] mb-8 relative">
                 ...
                 {/* Underline neon glow */}
                 <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-transparent via-[#3B82F6] to-transparent blur-[120px]"></div>
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-6 w-full max-w-xl mx-auto">
                <button 
                  ...
                  type="button"
                  className="bg-[#C8A028] hover:bg-[#E8C050] text-white font-bold px-10 py-5 rounded-xl transition-all shadow-[0_4px_15px_rgba(200,160,40,0.3)] hover:-translate-y-1 hover:shadow-[0_4px_25px_rgba(200,160,40,0.5)] flex items-center justify-center text-lg w-full sm:w-auto relative overflow-hidden group outline-none"
                >
